...
- FundamentalsからAirway/Breathing/Circulation、臓器別、ECMO/MCS、全身管理、bedside systems、special populations、toxicology、ethics/safetyまで75実体SSOT入口を配置
...
- `git diff --check`
- 75 SSOT（template除外）のidentity/review log/minimum-depth/新人・ベテラン導線gate
- 75 SSOTすべての直接外部Evidence identity（DOI/PMID/公式一次source）gate
