...
このMapは網羅範囲と本体ページの置き場所を示します。チェックボックスは執筆進捗であり、臨床的重要度ではありません。
...
- [ ] Pharmacology/nutrition: [critical care PK/PD](13_Pharmacology/PKPD/CRITICAL_CARE_PKPD.md)、[high-alert infusion safety](13_Pharmacology/Medication_Safety/HIGH_ALERT_INFUSION_SAFETY.md)、[critical care nutrition](14_Nutrition/Critical_Care_Nutrition/CRITICAL_CARE_NUTRITION.md)、[refeeding](14_Nutrition/Refeeding/REFEEDING_SYNDROME.md)（pain/sedation/delirium/sleep・rehabilitation/PICSは次Phase）
