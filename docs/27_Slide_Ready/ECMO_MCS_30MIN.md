...
# ECMO / MCS — 30-minute Slide Ready

## Learning Objectives

1. VV/VA-ECMOのsupport範囲を説明する。
2. ECMO emergencyをpatient–cannula–circuit–machineで整理する。
3. temporary MCSをphenotypeとexit strategyで考える。
...
- ELSO VV-ECMO 2021; VA-ECMO 2021; Circuit/Anticoagulation/Transport 2022
- ACC Cardiogenic Shock CCG 2025
