...
**非侵襲的換気（noninvasive ventilation：NIV）**は、気管挿管をせずmask等のinterfaceから陽圧換気を行うsupportです。

**簡単に言うと：** 自分の気道を保ったまま吸気と呼気を圧で助けますが、嘔吐物や分泌物から気道を守る機能はありません。

| 用語 | 意味 | 観察 |
|---|---|---|
| interface | maskなど患者と装置をつなぐ部分 | fit、leak、皮膚、圧迫、comfort |
| IPAP | 吸気時の陽圧 | 換気量、呼吸仕事量、leak、同調性 |
| EPAP | 呼気時の陽圧 | 酸素化、気道開存、循環への影響 |
| leak | interface周囲等からの漏れ | 眼刺激、換気不足、auto-trigger、乾燥 |

**新人看護師の到達点：** airway protection、嘔吐・分泌物、意識、呼吸努力、同期、leak、皮膚、血圧を確認し、悪化を直ちに共有すること。

**ベテラン向け深掘り：** 適応疾患、failure予測、mask休止のrisk、patient–ventilator interaction、挿管遅延の害を統合します。

### 報告例

> 「NIV開始○分、modeと圧は○○、FiO₂は○です。呼吸数、呼吸努力、意識、SpO₂、血圧、呼気VT、leakは○○で、開始前から○○へ変化しています。嘔吐・分泌物とairway protectionは○○です。」
...
|---|---|---|---|
| 2026-08-12 | Codex | V2 terminology / interface safety / escalation | Staged-learning introduction added; respiratory nursing review needed |
