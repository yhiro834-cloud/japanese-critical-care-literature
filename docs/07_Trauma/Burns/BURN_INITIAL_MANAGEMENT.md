...
tags: [burn, inhalation-injury, resuscitation, transfer]
related: [../Initial_Assessment/TRAUMA_INITIAL_ASSESSMENT.md, ../../01_Airway/Assessment_Emergencies/AIRWAY_ASSESSMENT_EMERGENCIES.md]
ssot: true
---

# Burn Initial Management

![皮膚の層と熱傷深度の教育用模式図](../../../assets/trauma/burn_depth_skin_layers.svg)
